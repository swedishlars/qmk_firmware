...
const uint8_t PROGMEM ledcolors[][DRIVER_LED_TOTAL][4] = {
    ...
    //  SHIFT     \         Z         X         C         V         B         N         M         ,         .         SHIFT     UP        ?
        L__OFF,   L__OFF,   L__OFF,   L__OFF,   L__OFF,   L__OFF,   L_DRED,   L_DMAG,   L_DCYA,   L_DCYA,   L_DCYA,   L__OFF,   L_DYEL,   L__OFF,
    //  CTRL      FN        ALT                                     SPACE                         ALTGR     FN        LEFT      DOWN      RIGHT
    ...
    //  SHIFT     \         Z         X         C         V         B         N         M         ,         .         SHIFT     UP        ?
        L__OFF,   L__OFF,   L__OFF,   L_BVIO,   L__OFF,   L__OFF,   L__OFF,   L_BMAG,   L_BBLU,   L__OFF,   L__OFF,   L__OFF,   L_BAZU,   L__OFF,
    //  CTRL      FN        ALT                                     SPACE                         ALTGR     FN        LEFT      DOWN      RIGHT
...
void rgb_matrix_indicators_user(void) {
    ...
    if (host_keyboard_led_state().caps_lock) {
        HSVB hsvb = L_BCYA;
        set_led_color(28, hsvb, USE_RGB_MATRIX_VALUE_ON);
    }
}

...
[_SWITCH] = LAYOUT(
  ...
  //|------+-------+--------+--------+--------+------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|
  KC_SYSTEM_SLEEP,KC_NO,KC_NO,KC_NO,  KC_NO,   KC_NO, KC_NO,      KC_NO,   HF_CONT,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   HF_TOGG,
  //|------+-------+--------+--------+--------+------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|
...
void keyboard_post_init_user(void) {
    ...
    // TODO rm:
    // pimoroni trackball rgb
    /* pimoroni_trackball_set_rgbw(red,green,blue,white); */

    // TODO testing delay oled statrtup to see if it helps i2c
    // did not help
    /* wait_ms(2000); */
